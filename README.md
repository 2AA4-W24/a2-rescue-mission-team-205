...
# [A2] Island ca.mcmaster.se2aa4.island.team205.Explorer
...
- The `ca.mcmaster.se2aa4.island.team_205_.Explorer` class implements the command center, used to compete with the others. 
